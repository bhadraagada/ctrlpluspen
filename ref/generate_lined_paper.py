...
from demo_lined_paper import Hand
...
os.makedirs('img/lined_paper', exist_ok=True)
...
print("Generating handwriting on lined paper...")
...
for style in available_styles:
    for bias in bias_values:
        filename = f'img/lined_paper/style_{style}_bias_{bias}.svg'
        ...
        hand.write(
            ...
            biases=biases,
            styles=styles,
            stroke_colors=['#1a1a1a' for _ in lines],  # Dark gray/black ink
            stroke_widths=[2 for _ in lines]
        )

print("\n✓ All lined paper variations generated successfully!")
print("Check the 'img/lined_paper/' directory")
